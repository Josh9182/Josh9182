...
Project Name  | Description   |  Topic
------------- | ------------- | ------------------
[Medical Tech Financial Analysis](https://github.com/Josh9182/Tableau-Projects)| Using Excel to craft a custom made spreadsheet in regard to OrthoRelief and its financial information, it will be visualized in Tableau. | Excel, VBA, Tableau
|  |
